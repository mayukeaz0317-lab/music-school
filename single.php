        ...
        <div class="container">
            <div class="breadcrumbs__inner">
                <ul class="breadcrumbs__list">
                    ...
                    <li class="breadcrumbs__item"><a href="<?php echo esc_url(home_url('/blog/')); ?>">ブログ</a></li>
                    <li class="breadcrumbs__item"><a href="#">ギター</a></li>
                    <li class="breadcrumbs__item" aria-current="page">アルペジオが劇的に向上する３つの習慣</li>
                </ul>
            </div>
        </div>
    </nav>
                    ...
                    <ul class="related-posts__list">
                        ...
                        if ($categories) :
                            ...
                            $args = array(
                                ...
                                'post__not_in'   => array($post->ID), // 今の記事は除外
