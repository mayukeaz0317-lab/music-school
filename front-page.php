    ...
    <section class="concept">
        <div class="container container--concept">
            ...
            <picture class="concept__semicircle">
                <source srcset="<?php echo get_theme_file_uri('/images/icons/semicircle-sp.svg') ?>" media="(max-width: 576px)">
                <img src="<?php echo get_theme_file_uri('/images/icons/semicircle.svg') ?>" alt="">
            </picture>
            ...
            <ul class="reasons__list">
                <li class="reasons__item">
                    <picture class="reasons__img">
                        <source srcset="<?php echo get_theme_file_uri('/images/photo/reason01-sp.jpg') ?>" media="(max-width:768px)">
                        <img src="<?php echo get_theme_file_uri('/images/photo/reason01.jpg') ?>" alt="">
                    </picture>
                ...
                <li class="reasons__item">
                    <picture class="reasons__img">
                        <source srcset="<?php echo get_theme_file_uri('/images/photo/reason02-sp.jpg') ?>" media="(max-width:768px)">
                        <img src="<?php echo get_theme_file_uri('/images/photo/reason02.jpg') ?>" alt="">
                    </picture>
                    <div class="reasons__text">
                ...
                <li class="reasons__item">
                    <picture class="reasons__img">
                        <source srcset="<?php echo get_theme_file_uri('/images/photo/reason03-sp.jpg') ?>" media="(max-width:768px)">
                        <img src="<?php echo get_theme_file_uri('/images/photo/reason03.jpg') ?>" alt="">
                    </picture>
                    <div class="reasons__text">
    ...
    <section class="testimonial">
        <div class="container">
            ...
            <div class="testimonial__slider">
                <button class="slider-btn prev"><img src="<?php echo get_theme_file_uri('/images/icons/arrow-l.png') ?>" alt=""></button>
                <button class="slider-btn next"><img src="<?php echo get_theme_file_uri('/images/icons/arrow-r.png') ?>" alt=""></button>
                <div class="testimonial__viewport">
                    <ul class="testimonial__list">
                        <li class="testimonial__item">
                            <div class="testimonial__img">
                                <img src="<?php echo get_theme_file_uri('/images/photo/voice01.jpg') ?>" alt="">
                            </div>
                        ...
                        <li class="testimonial__item">
                            <div class="testimonial__img">
                                <img src="<?php echo get_theme_file_uri('/images/photo/voice02.jpg') ?>" alt="">
                            </div>
                            <div class="testimonial__text">
                        ...
                        <li class="testimonial__item">
                            <div class="testimonial__img">
                                <img src="<?php echo get_theme_file_uri('/images/photo/voice03.jpg') ?>" alt="">
                            </div>
                            <div class="testimonial__text">
                                <h3 class="testimonial__title">IT会社勤務　S.Eさん</h3>
